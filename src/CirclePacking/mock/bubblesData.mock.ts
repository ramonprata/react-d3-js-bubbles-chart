...
export const BUBBLES_MOCK_REAL_DATA = {
  name: "Walmart",
  children: [
    {
      name: "Hero Products",
    ...
    {
      name: "Owned & 3rd Party",
      children: [
        // {
        //   name: "In-Vehicle Technology (Lincoln Connect)",
        //   value: 3,
        //   equity: "+10%",
        // },
        ...
        // { name: "Ambassador Programs", value: 2.4, equity: "-3%" },
        // { name: "Email Newsletters", value: 2.3, equity: "-5%" },
        // { name: "Event Sponsorships", value: 2.2, equity: "-7%" },
        // { name: "Virtual Showroom Experiences", value: 2.1, equity: "-10%" },
        { name: "Branded Merchandise Store", value: 1.9, equity: "-14%" },
      ],
    },
    {
      name: "Paid & Earned",
      children: [
        // { name: "Social Media Advertisements", value: 3.4, equity: "+17%" },
        // { name: "Digital Marketing Campaigns", value: 3.1, equity: "+10%" },
        // { name: "Customer Testimonials", value: 3.1, equity: "+12%" },
    ...
    },
    {
      ...
      children: [
        ...
        //   equity: "+2%",
        // },
        // { name: "Pickup & Delivery Service", value: 2.7, equity: "+1%" },
        // {
        //   name: "Mobile App Features (Remote Functions, Lincoln Concierge)",
        //   value: 2.8,
        //   equity: "+3%",
        // },
        // { name: "Roadside Assistance", value: 2.4, equity: "-6%" },
        {
          name: "Financial Services (Lincoln Automotive Financial Services)",
          value: 2.1,
          equity: "-12%",
        },
      ],
